...
import {
  playerCards,
  cardBackSide,
} from "../../assets/images/player-cards/PlayerCards";
...
function GamePageContent({ difficulty, setDifficulty, setGameResult }) {
  ...
  function playTurn(card) {
    setClickedCards((prevClickedCards) => {
      ...
      if (
        prevClickedCards.some((clickedCard) => clickedCard.name === card.name)
      ) {
              ...
              <li key={index} onClick={() => playTurn(card)}>
                <div className="card-container">
                  <div className="card">
                    ...
                    <div className="card-back">{cardBackSide}</div>
                  </div>
                </div>
              </li>
            ))}
